...
DECLARE
	...
	table_enums TEXT[] DEFAULT ARRAY['colors', 'ethnic_groups', 'body_builds', 'eye_colors', 'hair_colors', 'nail_colors', 'beard_colors', 'eyebrow_colors', 'hand_hair_colors', 'hair_styles'];
	count INTEGER;
BEGIN
	FOR v_table_name IN (
		SELECT table_name
