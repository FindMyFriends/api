CREATE FUNCTION unit_tests.throwing_on_exactly_timeline_side_with_approximation() RETURNS test_result AS $BODY$
BEGIN
...
CREATE FUNCTION unit_tests.passing_with_approximation_without_exactly_timeline_side() RETURNS test_result AS $$
BEGIN
