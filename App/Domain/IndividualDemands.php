	...
	public function ask(array $description): Demand {
		$id = (new Storage\FlatQuery(
			...
			'INSERT INTO collective_demands (
				...
				ROW(NULL, :hands_nails_color_id, ROW(:hands_nails_length_value, :hands_nails_length_unit), :hands_nails_care)::nails,
				POINT(:location_coordinates_latitude, :location_coordinates_longitude),
				:face_freckles,
				:face_care,
				ROW(NULL, :face_beard_color_id, ROW(:face_beard_length_value, :face_beard_length_unit), :face_beard_style)::beards,
